...
public class Dao_Backup {
	...
	public List<EquipementDao> getAllEquipementDao(EntityManager em) {
		Query query = em.createNativeQuery("select * from EquipementDao",
				fr.gl.hopital_de_campagne.dao.EquipementDao.class);
		return query.getResultList();
	}

	public List<AvionDao> getAllAvionDao(EntityManager em) {
		Query query = em.createNativeQuery("select * from AvionDao",
				fr.gl.hopital_de_campagne.dao.AvionDao.class);
		return query.getResultList();
	}

	public List<ConfigurationDao> getAllConfigurationDao(EntityManager em) {
		Query query = em.createNativeQuery("select * from ConfigurationDao",
				fr.gl.hopital_de_campagne.dao.ConfigurationDao.class);
		return query.getResultList();
	}
	...
	public List<Container_containsDao> getAllContainer_containsDao(
		...
		Query query = em.createNativeQuery(
				"select * from Container_containsDao",
				fr.gl.hopital_de_campagne.dao.Container_containsDao.class);
		return query.getResultList();
	}

	public List<MedicamentDao> getAllMedicamentDao(EntityManager em) {
		Query query = em.createNativeQuery("select * from MedicamentDao",
				fr.gl.hopital_de_campagne.dao.MedicamentDao.class);
		return query.getResultList();
	}

	public List<SecteurDao> getAllSecteurDao(EntityManager em) {
		Query query = em.createNativeQuery("select * from SecteurDao",
				fr.gl.hopital_de_campagne.dao.SecteurDao.class);
		return query.getResultList();
	}
	...
	public static void addAvion(AvionDao avion) {
		EntityManagerFactory factory = Persistence
				.createEntityManagerFactory("Projet_GL");
	...
	public static void addContainer_contains(
			Container_containsDao container_contains) {
		EntityManagerFactory factory = Persistence
				.createEntityManagerFactory("Projet_GL");
		EntityManager em = factory.createEntityManager();
		em.getTransaction().begin();
	...
	public static void deleteContainer_contains(
			Container_containsDao container_contains) {
		EntityManagerFactory factory = Persistence
				.createEntityManagerFactory("Projet_GL");
		EntityManager em = factory.createEntityManager();
